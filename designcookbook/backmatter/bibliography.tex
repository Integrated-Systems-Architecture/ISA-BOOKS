...
\begin{itemize}
  \item C.~Spear and G.~Tumbush, \emph{SystemVerilog for Verification},
        ...
        and the natural sequel to \refverificationbook.
  ...
  \item P.~Ashenden and J.~Lewis, \emph{VHDL-2008: Just the New Stuff}.
        Short, and it covers most of what \cref{ch:philosophy} says VHDL can do.
...
\begin{itemize}
  ...
  \item \emph{OSVVM} (\url{https://osvvm.org}) and \emph{UVVM}
        ...
        referred to throughout \cref{ch:philosophy} and \refverificationbook.
